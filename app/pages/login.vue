  ...
  <div class="min-h-dvh bg-zinc-950 flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
      ...
      <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 space-y-5">
        ...
        <!-- Error -->
        <Transition name="err">
          <div v-if="error" class="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-red-500/10 border border-red-500/20 text-sm text-red-400">
