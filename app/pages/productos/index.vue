                ...
                <div class="flex items-start justify-between gap-3">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-2 text-[11px] text-zinc-500 flex-wrap">
                            ...
                            <span class="px-1.5 py-0.5 rounded bg-violet-500/10 text-violet-400 font-mono">{{
                                p.categoria }}</span>
                            <span class="text-zinc-700">·</span>
...
v-for="p in productosFiltrados" :key="p.id"
                        ...
                        <td class="td"><span class="mono text-sm font-medium" :class="margenColor(p)">{{ calcMargen(p)
                                }}%</span>
                        </td>
                        <td class="td">
...
v-if="modalAbierto"
                            ...
                            <div class="flex items-center justify-between px-5 py-4 border-b border-zinc-800">
                                <h2 class="text-white font-bold tracking-tight">{{ editando ? 'Editar producto' : 'Nuevo                                    producto' }}
                                </h2>
                                <button
                            ...
                            <div class="p-5 space-y-4 max-h-[70dvh] overflow-y-auto">
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <input
v-model="form.categoria" class="field-input" placeholder="Ej: Cereales"
                                            list="cat-opts">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input
v-model.number="form.costo" type="number" min="0" step="0.01"
                                            class="field-input" placeholder="0.00">
                                    </div>
                                    <div>
                                        <label class="field-label">Precio de venta *</label>
                                        <input
v-model.number="form.precio_venta" type="number" min="0" step="0.01"
                                            class="field-input" placeholder="0.00">
                                    </div>
                                </div>
...
class="w-3.5 h-3.5 shrink-0" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <span class="mono font-medium">{{ ((form.precio_venta - form.costo) /
                                        form.precio_venta *
...
class="w-3.5 h-3.5 shrink-0" viewBox="0 0 24 24" fill="none"
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input
v-model.number="form.stock" type="number" min="0" class="field-input"
                                            placeholder="0">
                                    </div>
                                    <div>
                                        <label class="field-label">Stock mínimo</label>
                                        <input
v-model.number="form.stock_minimo" type="number" min="0"
