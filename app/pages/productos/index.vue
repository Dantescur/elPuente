<template>
  <div class="p-4 sm:p-6 lg:p-8 xl:p-10">
        ...
        <thead>
          <tr class="border-b border-zinc-800">
            <th class="th-sort" @click="toggleSort('nombre')">
              Nombre
              <SortIcon field="nombre" :active="sortField" :dir="sortDir" />
            </th>
            <th class="th">Categoría</th>
            <th class="th-sort" @click="toggleSort('costo')">
              Costo
              <SortIcon field="costo" :active="sortField" :dir="sortDir" />
            </th>
            <th class="th-sort" @click="toggleSort('precio_venta')">
              Precio venta
              <SortIcon field="precio_venta" :active="sortField" :dir="sortDir" />
            </th>
            <th class="th-sort" @click="toggleSort('margen')">
              Margen
              <SortIcon field="margen" :active="sortField" :dir="sortDir" />
            </th>
            ...
            <th class="th-sort" @click="toggleSort('estado')">
              Estado
              <SortIcon field="estado" :active="sortField" :dir="sortDir" />
            </th>
        ...
        <tbody>
          <tr v-for="p in productosFiltrados" :key="p.id"
            ...
            <td class="td text-right">
              ...
              <button class="p-1.5 text-red-500 hover:text-red-300 hover:bg-zinc-700 rounded-md transition-all"
    ...
    <div v-else class="py-16 text-center text-zinc-600">
      <svg class="w-10 h-10 mx-auto mb-3 opacity-30" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        stroke-width="1.5">
        <path
          ...
          <Transition name="sheet">
            <div v-if="modalAbierto"
              ...
              <div class="p-5 space-y-4 max-h-[70dvh] overflow-y-auto">
                ...
                <div class="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input v-model.number="form.costo" type="number" min="0" step="0.01" class="field-input"
                      placeholder="0.00">
                  </div>
                  <div>
                ...
                <!-- Live margin preview -->
                <div v-if="form.costo > 0 && form.precio_venta > form.costo"
                ...
                <div v-else-if="form.costo > 0 && form.precio_venta > 0 && form.precio_venta <= form.costo"
              ...
              <div class="flex gap-2 px-5 py-4 border-t border-zinc-800">
                ...
                <button :disabled="guardando || !formValido"
...
.th-sort {
  @apply px-4 py-3 text-left text-[10px] font-semibold uppercase tracking-widest text-zinc-500 cursor-pointer hover:text-zinc-300 select-none transition-colors;
}
